...
const PACKAGE_ROOT = path.resolve(
    ...
    path.dirname('file://package.js'.substr(7)),
);
...
export { add, build, buildDev, buildDist, callCompiler, checkInsideProject, clean, create, develop, getPeerDeps, install, publish, remove, test };
export default { add, build, buildDev, buildDist, callCompiler, checkInsideProject, clean, create, develop, getPeerDeps, install, publish, remove, test };
