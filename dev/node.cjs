...
var node = { add, build, buildDev, buildDist, callCompiler, checkInsideProject, clean, create, develop, getPeerDeps, install, publish, remove, test };

exports.add = add;
exports.build = build;
exports.buildDev = buildDev;
exports.buildDist = buildDist;
exports.callCompiler = callCompiler;
exports.checkInsideProject = checkInsideProject;
exports.clean = clean;
