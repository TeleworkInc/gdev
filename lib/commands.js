...
// import rollupDevEs from '../.gnv/config.rollup.devEs.mjs';
// import rollupDevCjs from '../.gnv/config.rollup.devCjs.mjs';
...
export const buildDev = async () => {
  ...
  await shell(
      'rollup -c .gnv/config.rollup.devEs.mjs',
      'rollup -c .gnv/config.rollup.devCjs.mjs',
  );
...
// import rollupDistEs from '../.gnv/config.rollup.distEs.mjs';
// import rollupDistCjs from '../.gnv/config.rollup.distCjs.mjs';
...
export const buildDist = async () => {
  ...
  await shell(
      'rollup -c .gnv/config.rollup.distEs.mjs',
      'rollup -c .gnv/config.rollup.distCjs.mjs',
      /**
       * Create dist/exe.js.
       *
