...
/**
 * Install global `gnvDependencies`.
 */
export { installGnvDependencies } from '../package.js';

/**
 * Install local `gnvDependencies`.
 */
export { installPeerDependencies } from '../package.js';

/**
 * Install this dependencies for this package or the package.json in
 * `process.cwd()`.
 */
export { install } from '../package.js';
